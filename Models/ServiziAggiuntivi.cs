...
namespace _8MarzoTest.Models
{
    public class ServiziAggiuntivi
    {
        ...
        [Display(Name = "Prezzo")]
        public decimal ColazioneInCameraPrezzo { get; set; }
        [Display(Name = "Data")]
        ...
        [Display(Name = "Prezzo")]
        public decimal MiniBarPrezzo { get; set; }
        [Display(Name = "Data")]
        ...
        [Display(Name = "Prezzo")]
        public decimal InternetPrezzo { get; set; }
        [Display(Name = "Data")]
        ...
        [Display(Name = "Prezzo")]
        public decimal LettoExtraPrezzo { get; set; }
        [Display(Name = "Data")]
        ...
        [Display(Name = "Prezzo")]
        public decimal CullaPrezzo { get; set; }
        [Display(Name = "Data")]
